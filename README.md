...
```text
android/app/build/outputs/apk/release/zl-music-v1.8.7-x86.apk
android/app/build/outputs/apk/release/zl-music-v1.8.7-x86_64.apk
android/app/build/outputs/apk/release/zl-music-v1.8.7-arm64-v8a.apk
android/app/build/outputs/apk/release/zl-music-v1.8.7-armeabi-v7a.apk
android/app/build/outputs/apk/release/zl-music-v1.8.7-universal.apk
```
...
C:\Data\NOX\Nox\bin\nox_adb.exe -s 127.0.0.1:62001 install -r android\app\build\outputs\apk\release\zl-music-v1.8.7-x86.apk
...
npm run tv:lint
npm run tv:assemble
aapt dump badging android/app/build/outputs/apk/release/zl-music-v1.8.7-universal.apk
```
...
- `zl-music-v1.8.7-arm64-v8a.apk`：大多数 64 位 Android TV / 盒子。
- `zl-music-v1.8.7-universal.apk`：不确定设备架构时使用。
- `zl-music-v1.8.7-x86.apk`：夜神模拟器。
